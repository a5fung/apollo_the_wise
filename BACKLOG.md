...
- **North Star** (theme/narrative + CATALYST load-bearing in EP): #149 #165 #189 #190 #191 #192 #197 #198 #200 #201 #202 #203 #213 (theme-validation false-removal — Haiku evicted SNDK/SIMO from Memory&Storage) · **catalyst-sourcing backbone #210** (operator direction 6/5: DIRECT primary sources > LLM-discovery — umbrella over #187✓/#208/#191; PARKS #186) · **#211 news-gap discovery loop** (unknown-rate = source-coverage KPI; LLM finds where the catalyst was reported → onboard that source; drives #210's priorities) · #208 (EDGAR 6-K foreign-filer gap) · **#212 questioner/investigator dialogic loop** (skeptical-PM interrogates tool-grounded analyst; the production version of the advisor/questioner dynamic — big-rock, grounding is make-or-break; ties #211/#167) · **model-eval governance #207** (quarterly review, auto-surfaces via `data_gated_reviews::model_selection_quarterly_review` 2026-08-01; SSoT `docs/model_selection_baseline.md`) · #186 (Gemini LLM-discovery — PARKED under #210). (#197/#198 = quality-aware admission / conviction-override; re-bucket to Stocks-in-Play if preferred.)
- **Operational safety / hardening**: #152 #172 #179 #205 (#172 = partial-exit /simplify refactor, gated behind #151 split; #205 = stale-test fix)
