...
- [ ] **M&A buyouts past direction-aware filter** (2026-05-17) — BZH 5/11 + KALV 4/29 slipped past `ma_filter.is_likely_ma` despite being labeled `other / M&A buyout` by operator. Re-check direction-aware logic for these cases; possibly missing keyword variants. Surfaced from catalyst-label review §8.
