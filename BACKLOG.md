...
- **Miscellaneous** (no home project): #121 (briefing → shared Telegram formatting layer) · #195 (SECURITY — rotate portfolio-app2 app_password; operator-action)
