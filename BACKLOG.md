...
- **Live-money cutover** (MAGNA53): #150 (↓DOWNGRADED 6/3 — entry-tuning, not safety) #151 #183 #184 #224 (#183 = ORB classifier IEX/window mislabel; #184 = live fill-verification / broker-authoritative trade-state mirror; #224 = SIP-replay robustness checks. **#223✓ DONE 6/6 — Gate-3 SIP-selection verdict: paper −$9,475 is an IEX feed artifact; +2.27R same-basis selection delta; GO-supportive for reduced-size 6/22. Doc `docs/analysis/sip_replay_gate3_2026-06-06.md`.** Done & dropped: #174 #180 #181 #182 #223.)
