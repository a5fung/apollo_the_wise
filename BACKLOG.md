...
- **Stocks in Play** (detection · setups · entries · 9M · cooldown · flags · entry-techniques): #55 #56 #60 #65 #81 #97 #113 #115 #116 #134 #146 #166 #167 #168 #170 #178
...
- **North Star** (theme/narrative + CATALYST load-bearing in EP): #149 #165 #189 #190 #191 #192 #197 #198 #200 #201 #202 #203 · **model-eval governance #207** (quarterly model-selection review — auto-surfaces via `data_gated_reviews::model_selection_quarterly_review`, earliest 2026-08-01; SSoT `docs/model_selection_baseline.md`) · #186 (Gemini 3rd-validator eval). (#197/#198 = quality-aware admission / conviction-override — make grade load-bearing in the safeguard decision; re-bucket to Stocks-in-Play if preferred.)
