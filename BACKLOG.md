...
- **North Star** (theme/narrative + CATALYST load-bearing in EP): #165 · catalyst-axis cluster #189 #190 #191 #192 #197 #198 #200 #201 #202 #203 · **model-eval governance #207** (quarterly model-selection review — auto-surfaces via `data_gated_reviews::model_selection_quarterly_review`, earliest 2026-08-01; SSoT `docs/model_selection_baseline.md`) · #186 (Gemini 3rd-validator eval)
- **Operational safety / hardening**: #149 #152 #172 #179 #205
