...
class TelegramChannel:
    ...
    async def _handle_help(
        ...
        text = (
            ...
            "\n"
            "*📈 Market Intelligence*\n"
            "• Morning briefing — regime, EP alerts, RS leaders, active themes\n"
            "• EP alerts — gap-up stocks with game-changing catalysts (MAGNA53 scoring)\n"
            ...
            "• MA pullbacks — RS stocks pulling back to 10/20/50 MA (buying opportunities)\n"
            "• Teach me — tell me about stocks/themes you've spotted; I'll track them\n"
            "_Example: 'Send morning briefing' · 'Any EPs today?' · 'What's the market regime?'_\n"
            "_Example: 'Top RS stocks' · 'What themes are active?' · 'Optical stocks near 20MA?'_\n"
            "_Example: 'AXTI is working, it's a photonics play' → I'll ask questions and add it_\n"
            "\n"
            "*📊 Finance*\n"
