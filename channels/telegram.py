...
class TelegramChannel:
    ...
    async def _handle_help(
        ...
        text = (
            ...
            "• Score any ticker — instant RS rank vs today's universe\n"
            "• Fundamentals — O'Neil-style quarterly EPS/revenue/GM% table + quality flags\n"
            "• Screener — RS + theme stage + fundamentals combined into a composite score\n"
            "• Teach me — tell me about stocks/themes you've spotted; I'll track them\n"
            "_Briefings: 'Send evening briefing' · 'Send morning briefing'_\n"
            "_EPs & regime: 'Any EPs today?' · 'What's the market regime?'_\n"
            "_Leaders & themes: 'Top RS stocks' · 'What themes are active?' · 'Optical stocks near 20MA?'_\n"
            "_Fundamentals: 'Fundamentals on CIEN' · 'EPS growth for AXTI'_\n"
            "_Screener: 'Find top 20 stocks with RS > 70 and EPS growth > 25%'_\n"
            "_Screener: 'Best Accelerating theme stocks with fundamentals'_\n"
            "_Teaching: 'AXTI is working, it\\'s a photonics play' → I\\'ll ask and track it_\n"
            "\n"
            "*📊 Finance*\n"
