...
_ADVISOR = OutputCeiling(
    1500, "THEME_ADVISOR_MODEL", "claude-opus-5",
...
_JUDGE = OutputCeiling(
    1500, "JUDGE_MODEL", "claude-opus-5",
...
CEILINGS: dict[str, OutputCeiling] = {
    ...
    "ep_catalyst_grade": OutputCeiling(
        1500, "GROUNDED_GRADE_MODEL", "claude-sonnet-5",
    ...
    "narrative_theme_discovery": OutputCeiling(
        1500, "THEME_MODEL", "claude-sonnet-5",
    ...
    "theme_merge_adjudication": OutputCeiling(
        700, None, "claude-haiku-4-5-20251001",
    ...
    "theme_ecosystem_assignment": OutputCeiling(
        1000, "ECOSYSTEM_ASSIGN_MODEL", "claude-haiku-4-5-20251001",
    ...
    "postmortem": OutputCeiling(
        1500, "POSTMORTEM_MODEL", "claude-sonnet-5",
    ...
    "system_review_weekly": OutputCeiling(
        2800, "SYSTEM_REVIEW_MODEL", "claude-sonnet-5",
    ...
    "description_backfill": OutputCeiling(
        2000, "DESCRIPTION_MODEL", "claude-haiku-4-5-20251001",
        "35 haiku calls, max completed 724 (36% of cap)."),
    "market_agent_general": OutputCeiling(
        1024, "MARKET_AGENT_MODEL", "claude-haiku-4-5-20251001",
        "n=1 completed at 213 (21% of cap)."),

    # ── orchestrator container ──
    "orchestrator": OutputCeiling(
        4096, "ORCHESTRATOR_MODEL", "claude-sonnet-5",
    ...
    "context_compression": OutputCeiling(
        2500, "COMPRESSION_MODEL", "claude-haiku-4-5-20251001",
    ...
    "healthcheck": OutputCeiling(
        5, "HEALTHCHECK_MODEL", "claude-haiku-4-5-20251001",
