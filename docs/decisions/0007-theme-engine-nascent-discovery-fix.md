...
**STEP 2 RUN 2026-05-31 (isolated grouping test — real prompt + tool + Sonnet, faithful descriptions; `scripts/probes/_replay_theme_discovery_grouping.py`):** fed the 6 drone leaders (cross-sector Tech+Industrials) + 10 unrelated bull-bounce accelerators to the REAL discovery prompt/tool/model.
