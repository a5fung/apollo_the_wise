    ...
    return [
        {
            ...
            "description": (
                ...
                "It also has PAPER TRADE data: simulated EP trade history with entry/exit prices, "
                "P&L, stop prices, hold days — all stored in the database. "
                "Use for: stock picks or ideas, sector analysis, EP/gap-up alerts, market conditions, "
                "top momentum stocks, morning/evening briefing, theme health, audit log (engine events, "
