...
- #266 | 2026-06-19 | in_progress | theme membership validation at BIRTH + identity-change. EVIDENCE RUN DONE 6/17 (docs/analysis/theme_birth_validation_evidence_2026-06-17.md; scripts/_theme_birth_validation_evidence.py): SUPPORTED — strip-latency median 6.0d, 73% of strips land >3d after birth, 234 themes carry bad-birth members below the round-trip alarm; ALL removal reasons are description-mismatch = birth-detectable. ROOT-CAUSE FIRST (0% caught ≤1h): why does post-assignment validation miss birth description-mismatches? → then run the Mon/Wed/Fri description-match at birth+identity-change (CHANGE_PROCESS + sign-off); re-run probe to confirm latency shifts left
