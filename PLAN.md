...
- #326 | 2026-09-15 | pending | 9M Day-2 ORB entry → RETIRE for consolidation entries (CUT-OVER DECISION, operator vision). 9M becomes a universe-to-watch feeding the Family-A tightness→expansion entry (methodology user_pradeep_9m_universe_methodology). GATE (registry ninem_day2_retire_for_consolidation, earliest 9/15): (1) Family-A entry layer BUILT (ADR 0013 Phase 3, not just shadow recorder); (2) 9M universe wired in (#311 "9M→flag pipeline") shadow-tracking realized R; (3) N≥15 head-to-head pairs (Day-2 ORB R vs consolidation-entry R on same 9M names) → if consolidation matches-or-beats → retire 9m_day2 to shadow (CHANGE_PROCESS + sign-off). COUPLING: BLOCKS the 9M Day-2 → live-money promotion (Q3) — don't take it to real money while its entry is a retirement candidate. Depends on #270/#12 (Family A) + #297 (Family B) + #311 (P4)
